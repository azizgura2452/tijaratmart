...
class ControllerVendorStore extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') 	) {
			...
			$this->response->redirect($this->url->link('vendor/store', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('vendor/store', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('vendor/store/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('vendor/store/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			...
			$data['stores'][] = array(
				...
				'mcountry'	  => $mcountry,
				'mzone'		  => $mzone,
				'edit'        => $this->url->link('vendor/store/edit', 'token=' . $this->session->data['token'] . '&vs_id=' . $result['vs_id'] . $url, true)
			);
		}
		...
		$data['sort_name'] = $this->url->link('vendor/store', 'token=' . $this->session->data['token'] . '&sort=name' . $url, true);
		$data['sort_vendorname'] = $this->url->link('vendor/store', 'token=' . $this->session->data['token'] . '&sort=vendorname' . $url, true);
		$data['sort_country'] = $this->url->link('vendor/store', 'token=' . $this->session->data['token'] . '&sort=country' . $url, true);
		$data['sort_zone'] = $this->url->link('vendor/store', 'token=' . $this->session->data['token'] . '&sort=zone' . $url, true);
		$data['sort_sort_order'] = $this->url->link('vendor/store', 'token=' . $this->session->data['token'] . '&sort=sort_order' . $url, true);
		...
		$pagination->url = $this->url->link('vendor/store', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('vendor/store_list.tpl', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['vs_id'])) {
			$data['action'] = $this->url->link('vendor/store/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('vendor/store/edit', 'token=' . $this->session->data['token'] . '&vs_id=' . $this->request->get['vs_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('vendor/store', 'token=' . $this->session->data['token'] . $url, true);
		...
		$this->response->setOutput($this->load->view('vendor/store_form.tpl', $data));
	}
