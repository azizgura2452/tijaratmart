...
class ControllerVendorIncome  extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('vendor/income', 'token=' . $this->session->data['token'] .$url, true));
		}
	...
	public function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('vendor/income', 'token=' . $this->session->data['token'] . $url, true)
		);
		
		$data['add']	=$this->url->link('vendor/income/add','&token='.$this->session->data['token'].$url,true);
		...
		// Remaining Amount
			...
			$data['incomes'][] = array(
				...
				'payment'       	=> $this->url->link('vendor/income/add', 'token=' . $this->session->data['token'] .'&vendor_id=' . $report['vendor_id'] . $url, true)
			);
		}
		...
		$data['sort_seller']    	= $this->url->link('vendor/income', 'token=' . $this->session->data['token'] . '&sort=seller' . $url, true);
		$data['sort_tamount']  		= $this->url->link('vendor/income', 'token=' . $this->session->data['token'] . '&sort=tamount' . $url, true);
		$data['sort_samount']  		= $this->url->link('vendor/income', 'token=' . $this->session->data['token'] . '&sort=samount' . $url, true);
		$data['sort_admin_amount']  = $this->url->link('vendor/income', 'token=' . $this->session->data['token'] . '&sort=admin_amount' . $url, true);
		...
		$pagination->url   	= $this->url->link('vendor/income', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('vendor/income_list.tpl', $data));
	}
	...
	protected function getForm() {
		...
		$data['action'] = $this->url->link('vendor/income/add', 'token=' . $this->session->data['token'] .'&vendor_id=' . $this->request->get['vendor_id'] . $url, true);
		...
		$data['cancel'] = $this->url->link('vendor/income', 'token=' . $this->session->data['token'] . $url, true);
		$data['token'] = $this->session->data['token'];	
		$data['header'] = $this->load->controller('common/header');
		$data['column_left'] = $this->load->controller('common/column_left');
		$data['footer'] = $this->load->controller('common/footer');
		...
		$this->response->setOutput($this->load->view('vendor/payment_form.tpl', $data));
	}
	...
	public function getPaymentMethod(){
		...
		$this->response->setOutput($this->load->view('vendor/bank_detail.tpl', $data));
	}		
}
?>