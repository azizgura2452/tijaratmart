...
class ControllervendorExport extends Controller { 
	...
	public function index() {		
		...
		$data['restore'] = $this->url->link('vendor/export/export', 'token=' . $this->session->data['token'], true);
		
		$data['export'] = $this->url->link('vendor/export/export', 'token=' . $this->session->data['token'], true);
		$data['export1'] = $this->url->link('vendor/export/export1', 'token=' . $this->session->data['token'], true);
