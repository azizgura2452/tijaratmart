...
class ControllerVendorReviewreport  extends Controller {
	...
	public function delete() {
		...
		if (isset($this->request->post['selected']) && $this->validateDelete()) {
			...
			$this->response->redirect($this->url->link('vendor/review_report', 'token=' . $this->session->data['token'] . $url, true));
		}
		$this->getList();
	}
	...
	public function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('vendor/review_report', 'token=' . $this->session->data['token'] . $url, true)
		);
		
		$data['delete']	=$this->url->link('vendor/review_report/delete','&token='.$this->session->data['token'].$url,true);
		...
		$data['sort_seller']    = $this->url->link('vendor/review_report', 'token=' . $this->session->data['token'] . '&sort=seller' . $url, true);
		$data['sort_customer']  = $this->url->link('vendor/review_report', 'token=' . $this->session->data['token'] . '&sort=customer' . $url, true);
		$data['sort_rating']  	= $this->url->link('vendor/review_report', 'token=' . $this->session->data['token'] . '&sort=rating' . $url, true);
		$data['sort_status']  	= $this->url->link('vendor/review_report', 'token=' . $this->session->data['token'] . '&sort=status' . $url, true);
		$data['sort_date']  	= $this->url->link('vendor/review_report', 'token=' . $this->session->data['token'] . '&sort=date' . $url, true);
		...
		$pagination->url   	= $this->url->link('vendor/review_report', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('vendor/review_report.tpl', $data));
	}
