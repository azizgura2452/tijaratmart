...
class ControllerVendorReview extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('vendor/review', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {	
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('vendor/review', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('vendor/review/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('vendor/review/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			...
			$data['reviews'][] = array(
				...
				'edit'        => $this->url->link('vendor/review/edit', 'token=' . $this->session->data['token'] . '&review_id=' . $result['review_id'] . $url, true)
			);
		}
		...
		$data['sort_seller']   = $this->url->link('vendor/review', 'token=' . $this->session->data['token'] . '&sort=seller' . $url, true);
		$data['sort_customer'] = $this->url->link('vendor/review', 'token=' . $this->session->data['token'] . '&sort=customer' . $url, true);
		$data['sort_status']   = $this->url->link('vendor/review', 'token=' . $this->session->data['token'] . '&sort=status' . $url, true);
		$data['sort_date']     = $this->url->link('vendor/review', 'token=' . $this->session->data['token'] . '&sort=date' . $url, true);
		...
		$pagination->url = $this->url->link('vendor/review', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('vendor/review_list.tpl', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['review_id'])) {
			$data['action'] = $this->url->link('vendor/review/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('vendor/review/edit', 'token=' . $this->session->data['token'] . '&review_id=' . $this->request->get['review_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('vendor/review', 'token=' . $this->session->data['token'] . $url, true);
		...
		$this->response->setOutput($this->load->view('vendor/review_form.tpl', $data));
	}
