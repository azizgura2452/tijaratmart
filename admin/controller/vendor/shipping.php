...
//print_r($store_name);die();
		...
		$data['bulkshipping'] = $this->url->link('vendor/shipping/bulkshipping', 'token=' . $this->session->data['token'] . $url, true);
		...
		$this->response->setOutput($this->load->view('vendor/shipping_list.tpl', $data));
	}
	...
	protected function getForm() {
		...
		$data['help_weightfrom'] 	= $this->language->get('help_weightfrom');
		...
		$this->response->setOutput($this->load->view('vendor/shipping_form.tpl', $data));
	}
	...
	public function bulkshipping(){
		...
		$this->response->setOutput($this->load->view('vendor/bulkshipping.tpl', $data));
	}
