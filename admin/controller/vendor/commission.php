...
class ControllerVendorCommission extends Controller {
	...
	public function add() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			...
			$this->response->redirect($this->url->link('vendor/commission', 'token=' . $this->session->data['token'] . $url, true));
		}
	...
	protected function getList() {	
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('vendor/commission', 'token=' . $this->session->data['token'] . $url, true)
		);

		$data['add'] = $this->url->link('vendor/commission/add', 'token=' . $this->session->data['token'] . $url, true);
		$data['delete'] = $this->url->link('vendor/commission/delete', 'token=' . $this->session->data['token'] . $url, true);
		...
		foreach ($results as $result) {
			...
			$data['categories'][] = array(
				...
				'catnames'      => $catnames,
				'edit'          => $this->url->link('vendor/commission/edit', 'token=' . $this->session->data['token'] . '&commission_id=' . $result['commission_id'] . $url, true)
			);
		}
		...
		$data['sort_id']   		 = $this->url->link('vendor/commission', 'token=' . $this->session->data['token'] . '&sort=id' . $url, true);
		$data['sort_category']   = $this->url->link('vendor/commission', 'token=' . $this->session->data['token'] . '&sort=category' . $url, true);
		$data['sort_commission'] = $this->url->link('vendor/commission', 'token=' . $this->session->data['token'] . '&sort=commission' . $url, true);
		...
		$pagination->url = $this->url->link('vendor/commission', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('vendor/commission_list.tpl', $data));
	}
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['commission_id'])) {
			$data['action'] = $this->url->link('vendor/commission/add', 'token=' . $this->session->data['token'] . $url, true);
		} else {
			$data['action'] = $this->url->link('vendor/commission/edit', 'token=' . $this->session->data['token'] . '&commission_id=' . $this->request->get['commission_id'] . $url, true);
		}

		$data['cancel'] = $this->url->link('vendor/commission', 'token=' . $this->session->data['token'] . $url, true);
		...
		$this->response->setOutput($this->load->view('vendor/commission_form.tpl', $data));
	}
