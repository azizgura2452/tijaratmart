...
class ControllerVendorCommissionreport  extends Controller {
	...
	public function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('vendor/commission_report', 'token=' . $this->session->data['token'] . $url, true)
		);
		...
		$data['sort_seller']    	= $this->url->link('vendor/commission_report', 'token=' . $this->session->data['token'] . '&sort=seller' . $url, true);
		$data['sort_name']  		= $this->url->link('vendor/commission_report', 'token=' . $this->session->data['token'] . '&sort=name' . $url, true);
		$data['sort_model']  		= $this->url->link('vendor/commission_report', 'token=' . $this->session->data['token'] . '&sort=model' . $url, true);
		$data['sort_qty']  		    = $this->url->link('vendor/commission_report', 'token=' . $this->session->data['token'] . '&sort=qty' . $url, true);
		$data['sort_price']  		= $this->url->link('vendor/commission_report', 'token=' . $this->session->data['token'] . '&sort=price' . $url, true);
		$data['sort_date']  		= $this->url->link('vendor/commission_report', 'token=' . $this->session->data['token'] . '&sort=date' . $url, true);
		$data['sort_percentage']  	= $this->url->link('vendor/commission_report', 'token=' . $this->session->data['token'] . '&sort=percentage' . $url, true);
		$data['sort_fixed']  	    = $this->url->link('vendor/commission_report', 'token=' . $this->session->data['token'] . '&sort=fixed' . $url, true);
		...
		$pagination->url   	= $this->url->link('vendor/commission_report', 'token=' . $this->session->data['token'] . $url . '&page={page}', true);
		...
		$this->response->setOutput($this->load->view('vendor/commission_report.tpl', $data));
	}
