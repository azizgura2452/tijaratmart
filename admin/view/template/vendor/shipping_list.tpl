				...
				<div class="row">
					<div class="col-sm-3">
						<div class="form-group">
							<label class="control-label" for="input-filter_store_name"><?php echo $column_store;?> </label>
						...
						<div class="form-group">
							<label class="control-label" for="input-filter_country"><?php echo $column_country;?> </label>
					...
					<div class="col-sm-3">
						<div class="form-group">
							<label class="control-label" for="input-filter_price"><?php echo $column_price;?> </label>
...
$('#button-filter').on('click', function() {
	var url = 'index.php?route=vendor/shipping&token=<?php echo $token; ?>';
...
<script>
  $(document).on('click', '.docdelete',function(){
	...
	$.ajax({
	url: 'index.php?route=vendor/shipping/shippingdelete&token=<?php echo $token; ?>&shipping_id='+shipping_id,
	type:'post',
	dataType:'json',
	beforeSend: function() {
	},
