          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($notification['notification_id'], $selected)) { ?>
					...
					<td class="text-left"><?php echo $notification['message']; ?></td>
					<td class="text-left"><?php echo $notification['date']; ?></td>
                  	<td class="text-right"><a href="<?php echo $notification['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
