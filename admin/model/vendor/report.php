...
class ModelVendorReport extends Model {	
	public function addTracks($order_product_id, $data) {
		...
		date_modified=now() where order_product_id='".$order_product_id."'";
		$this->db->query($sql);
	}	
	public function addOrdeStatus($order_id,$data) {
		...
		$this->db->query($sql);
		$order_product_id=0;
		$sql = "SELECT order_id FROM " . DB_PREFIX . "vendor_order_product where order_product_id='".$order_product_id."'";
		$query1 = $this->db->query($sql);
		
		
			$sql2 = "SELECT * FROM " . DB_PREFIX . "vendor_order_product where order_product_id='".$order_product_id."'";
