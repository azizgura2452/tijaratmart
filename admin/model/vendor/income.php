...
class ModelVendorincome extends Model {	
	...
	public function getVendorTotal($vendor_id){
		...
		$sql = "SELECT sum(total) AS total FROM " . DB_PREFIX . "vendor_order_product WHERE vendor_id ='".$vendor_id. "' And order_status_id IN(" . implode(",", $implode) . ")";
	...
	public function getShippingAmount($vendor_id){
		...
		$sql = "SELECT * FROM " . DB_PREFIX . "vendor_order_product  WHERE vendor_id='".$vendor_id."' AND  order_status_id IN(" . implode(",", $implode) . ")";
