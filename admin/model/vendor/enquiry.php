...
class ModelVendorEnquiry extends Model {
	public function deleteEnquiry($inquiry_id) {
		$sql="delete  from " . DB_PREFIX . "vendor_inquiry where inquiry_id='".$inquiry_id."'";
		$query=$this->db->query($sql);
	}
	
	public function getEnquiry($inquiry_id) {
		$sql = "SELECT * FROM " . DB_PREFIX . "vendor_inquiry where inquiry_id='".$inquiry_id."'";
		$query = $this->db->query($sql);
		return $query->row;
	}
	...
	public function getVendor($vendor_id) {
		...
		$sql = "SELECT *, CONCAT(firstname, ' ', lastname) AS sname FROM " . DB_PREFIX . "vendor where vendor_id='".$vendor_id."'";
		$query = $this->db->query($sql);
		return $query->row;
	}
	
	public function getCustomer($customer_id) {
		$sql = "SELECT *, CONCAT(firstname, ' ', lastname) AS customername FROM " . DB_PREFIX . "customer where customer_id='".$customer_id."'";
		$query = $this->db->query($sql);
		return $query->row;
	}
	...
	public function getProduct($product_id) {
		$sql = "SELECT * FROM " . DB_PREFIX . "product_description where product_id='".$product_id."'";
		$query = $this->db->query($sql);
		return $query->row;
	}
