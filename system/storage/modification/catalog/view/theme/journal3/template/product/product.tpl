      ...
      <div class="product-info <?php echo $classes; ?>">
        ...
        <div class="product-right">
          ...
          <?php if (!$j3->document->isPopup('options') && $j3->settings->get($stylePrefix . 'Stats') && ($j3->settings->get($stylePrefix . 'StatsPosition') == 'default')): ?>
            <div class="product-stats">
			 ...
			 <li class="product-vendor"><b><?php echo $text_vendorname; ?>:</b> <span><?php echo $vendorname; ?></span></li>
			  <?php } ?>
          ...
          <?php if(!empty($option['name'])){ ?>
            ...
            <?php } ?>
              ...
              <select name="option[<?php echo $option['product_option_id']; ?>]" id="input-option<?php echo $option['product_option_id']; ?>" class="form-control">
                ...
                <?php
                $gallery[] = array('src' => $option_value['tmdimage']['popup'], 'thumb' => $option_value['tmdimage']['galleryThumb'], 'subHtml' => $heading_title);
                ?>
        ...
        <label class="optionimage" rel="<?php echo $option_value['product_option_value_id']; ?>" <?php if (isset($option_value['tmdimage']['image2x']) && $option_value['tmdimage']['image2x']): ?>rel1="<?php echo $option_value['tmdimage']['image']; ?> 1x, <?php echo $option_value['tmdimage']['image2x']; ?> 2x"<?php endif; ?>  <?php if (isset($option_value['tmdimage']['thumb2x']) && $option_value['tmdimage']['thumb2x']): ?>thumbs="<?php echo $option_value['tmdimage']['thumb']; ?> 1x, <?php echo $option_value['tmdimage']['thumb2x']; ?> 2x"<?php endif; ?>>
          ...
          <div class="col-sm-12 col-xs-12">
            ...
            <?php if ($option_value['image']): ?> <img src="<?php echo $option_value['image']; ?>" alt="<?php echo $option_value['name']; ?> <?php if ($option_value['price']): ?> <?php echo $option_value['price_prefix']; ?> <?php echo $option_value['price']; ?> <?php endif; ?>,<?php if ($optionprosetting): ?> <?php if ($option_value['sku'] && $displaysku ==1): ?><?php echo $text_skulabel; ?>:(<?php echo $option_value['sku']; ?>)<?php endif; ?>,<?php if ($option_value['upc'] && $displayupc ==1): ?><?php echo $text_upclabel; ?>:(<?php echo $option_value['upc']; ?>)<?php endif; ?>,<?php if ($option_value['model'] && $displaymodel ==1): ?><?php echo $text_modellabel; ?>:(<?php echo $option_value['model']; ?>)<?php endif; ?>,<?php if ($option_value['ean'] && $displayean ==1): ?><?php echo $text_eanlabel; ?>:(<?php echo $option_value['ean']; ?>)<?php endif; ?> <?php endif; ?>" data-toggle="tooltip" data-tooltip-class="push-tooltip" data-placement="<?php echo $j3->settings->get($stylePrefix . 'PushTooltipPosition'); ?>" title="<?php echo $option_value['name']; ?> <?php if ($option_value['price']): ?> (<?php echo $option_value['price_prefix']; ?><?php echo $option_value['price']; ?>) <?php endif; ?>,<?php if ($optionprosetting): ?> <?php if ($option_value['sku'] && $displaysku ==1): ?><?php echo $text_skulabel; ?>:(<?php echo $option_value['sku']; ?>)<?php endif; ?>,<?php if ($option_value['upc'] && $displayupc ==1): ?><?php echo $text_upclabel; ?>:(<?php echo $option_value['upc']; ?>)<?php endif; ?>,<?php if ($option_value['model'] && $displaymodel ==1): ?><?php echo $text_modellabel; ?>:(<?php echo $option_value['model']; ?>)<?php endif; ?>,<?php if ($option_value['ean'] && $displayean ==1): ?><?php echo $text_eanlabel; ?>:(<?php echo $option_value['ean']; ?>)<?php endif; ?> <?php endif; ?>"/>
           <?php endif; ?>
...
<input type="hidden" name="opt_detail" value="Size: Default">
<?php endif; ?>
...
<?php endif; ?>
          ...
          <style>.product-options .btn{padding:5px 5px !important;margin-left:5px;}#product .optionimage{padding-left:0px;} .img{margin-right:10px;}.padd0{padding:0px;}.product-options .btn{padding:5px 5px !important;margin-left:5px !important;}</style>
<script type="text/javascript">
  ...
  <script type="text/javascript"><!--
    ...
    if(rel1){
      ...
      $('.product-image .swiper-slide-active').find('img:first').attr('src',img1);
      $('.product-image .swiper-slide-active').find('img:first').data('largeimg',img2);


      //thumbs
      $('.product-image .additional-images.swiper-slide-active').find('img:first').attr('src',thumb_img1);
      $('.product-image .additional-images.swiper-slide-active').find('img:first').attr('srcset',thumb_rel);


      console.log($('.product-image .swiper-slide-active').find('img:first'));
      //console.log(thumb_rel);
      //console.log($('.product-image .additional-images.swiper-slide-active').find('img:first'));
