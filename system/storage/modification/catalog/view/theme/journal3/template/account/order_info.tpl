...
<div id="account-order" class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>">
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover table-order">
          <thead>
            <tr>
			 ...
			 <?php if(!empty($tracking_code)) { ?>
              <td class="text-right"><?php echo $column_tracking; ?></td>
              </td>
			    <?php } ?>
          <!-- 09 06 2018 -->
		  
              <td class="text-right"><?php echo $column_price; ?></td>
              <td class="text-right"><?php echo 'HSN Code'; ?></td>
              ...
              ?>
              <td class="text-right"><?php echo 'Total GST'; ?></td>
          ...
          <!-- 09 06 2018 -->
              ...
              <td class="text-right"><?php echo $product['tax_rate_name']; ?></td>
              <td class="text-right"><?php echo number_format($product['tax_rate_figure'],2); ?>%</td>
              <?php
              //Custom GST Module
              if($local_order==true){
                $cgst = $product['tax_amount']/2;
                $sgst = $product['tax_amount']/2;
              ?>
              <td class="text-right"><?php echo $cgst; ?> @ <?php echo number_format(($product['tax_rate_figure']/2),2); ?>%</td>
              <td class="text-right"><?php echo $sgst; ?> @ <?php echo number_format(($product['tax_rate_figure']/2),2); ?>%</td>
              <?php
              }
              else{
              ?>
              <td class="text-right"><?php echo $product['tax']; ?> @ <?php echo number_format($product['tax_rate_figure'],2); ?>%</td>
              <?php
              }
              ?>
      ...
      <?php } ?>
      <?php if ($histories) { ?>
      <h2 class="title"><?php echo $text_history; ?></h2>
      <div class="table-responsive">
      <table class="table table-bordered table-hover">
        <thead>
          <tr>
