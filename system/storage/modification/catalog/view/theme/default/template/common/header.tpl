  ...
  <div class="container">
    ...
    <div id="top-links" class="nav pull-right">
      <ul class="list-inline">
			...
			<li class="tmd-menubox"><a href="<?php echo $allseller; ?>"><i class="fa fa-users fa-fw"></i>  <span class="hidden-xs hidden-sm hidden-md"> <?php echo $text_allseller; ?> </span></a></li>
			<?php } ?>
			
			<?php if ($vendorlogged) { ?>	
		      <li class="dropdown tmdseller"><a href="#" title="<?php echo $text_selleraccount; ?>" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-users"></i> <span class="hidden-xs hidden-sm hidden-md"><?php echo $text_selleraccount; ?></span> <span class="caret"></span></a>
        ...
        <?php } else { ?>
            <li class="tmd-menubox"><a href="<?php echo $sellerlogin; ?>"><i class="fa fa-sign-in fa-fw"></i>  <span class="hidden-xs hidden-sm hidden-md"> <?php echo $text_loginseller; ?></span></a></li>
            <?php } ?>
		<!--xml end-->
