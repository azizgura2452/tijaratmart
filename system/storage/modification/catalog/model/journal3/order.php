...
class ModelJournal3Order extends Model {
	...
	public function save($order_id, $order_data) {
		...
		if (!$this->customer->isLogged() && isset($this->request->post['order_data'])) {
			$order_data['customer_group_id'] = $this->request->post['order_data']['customer_group_id'];
			$order_data['firstname'] = $this->request->post['order_data']['payment_firstname'];
			$order_data['lastname'] = $this->request->post['order_data']['payment_lastname'];
			$order_data['email'] = $this->request->post['order_data']['email'];
			$order_data['telephone'] = $this->request->post['order_data']['telephone'];
