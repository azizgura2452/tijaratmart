...
class ModelCatalogProduct extends Model {
				...
				if ($product_option['type'] == 'select' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'image') {
					if (isset($product_option['product_option_value'])) {
						...
						foreach ($product_option['product_option_value'] as $product_option_value) {
							$this->db->query("INSERT INTO " . DB_PREFIX . "product_option_value SET product_option_id = '" . (int)$product_option_id . "', product_id = '" . (int)$product_id . "', option_id = '" . (int)$product_option['option_id'] . "', option_value_id = '" . (int)$product_option_value['option_value_id'] . "', quantity = '" . (int)$product_option_value['quantity'] . "', subtract = '" . (int)$product_option_value['subtract'] . "', price = '" . (float)$product_option_value['price'] . "', price_prefix = '" . $this->db->escape($product_option_value['price_prefix']) . "', points = '" . (int)$product_option_value['points'] . "', points_prefix = '" . $this->db->escape($product_option_value['points_prefix']) . "', weight = '" . (float)$product_option_value['weight'] . "', weight_prefix = '" . $this->db->escape($product_option_value['weight_prefix']) . "', sku = '" . $this->db->escape($product_option_value['sku']) . "', upc = '" . $this->db->escape($product_option_value['upc']) . "', model = '" . $this->db->escape($product_option_value['model']) . "', ean = '" . $this->db->escape($product_option_value['ean']) . "', description = '" . $this->db->escape($product_option_value['description']) . "', tmdimage = '" . $this->db->escape($product_option_value['image']) . "', tmddefault = '" . $this->db->escape(isset($product_option_value['tmddefault']) ? $product_option_value['tmddefault'] : 0) . "'");
						}
					}
				} else {
	...
	public function getProductOptions($product_id) {
		...
		foreach ($product_option_query->rows as $product_option) {
            ...
            'image'         => isset($product_option_value['tmdimage']) ? $product_option_value['tmdimage'] : '',
