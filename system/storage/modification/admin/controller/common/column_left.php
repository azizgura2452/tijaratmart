...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
        ...
        $tmdoption = array();
       if ($this->user->hasPermission('access', 'extension/module/tmdoptionprosetting')) {
        $tmdoption[] = array(
          'name'     => $this->language->get('text_tmdoptionsetting'),
      ...
      if ($tmdoption) {
        $data['menus'][] = array(
          'id'       => 'menu-tmdoption',
          'icon'     => 'fa-pencil',
          'name'     => $this->language->get('text_tmdoption'),
          'href'     => '',
          'children' => $tmdoption
        );
      }
			...
			if ($this->user->hasPermission('access', 'vendor/vendor')) {		
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/vendor/setting', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);					
			}
			...
			/* if ($this->user->hasPermission('access', 'vendor/store')) {		
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/store', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			} */
			...
			if ($this->user->hasPermission('access', 'vendor/commission')) {
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/commission', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'vendor/commission_report')) {
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/commission_report', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'vendor/product')) {
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/product', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'vendor/report')) {
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/report', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'vendor/review')) {
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/review', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'vendor/review_field')) {
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/review_field', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'vendor/mail')) {
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/mail', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'vendor/income')) {
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/income', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			/* if ($this->user->hasPermission('access', 'vendor/notification')) {
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/notification', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			} */
			...
			if ($this->user->hasPermission('access', 'vendor/shipping')) {
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/shipping', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'vendor/enquiry')) {
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/enquiry', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'vendor/import')) {
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/import', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}
			...
			if ($this->user->hasPermission('access', 'vendor/export')) {
				$seller[] = array(
					...
					'href'     => $this->url->link('vendor/export', 'token=' . $this->session->data['token'], true),
					'children' => array()		
				);
			}	
