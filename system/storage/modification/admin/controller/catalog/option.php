...
class ControllerCatalogOption extends Controller {
	...
	protected function getForm() {
      ...
      $data['entry_optionstyle']        = $this->language->get('entry_optionstyle');
      $data['entry_reqerror']           = $this->language->get('entry_reqerror');
      $data['entry_option_description'] = $this->language->get('entry_option_description');
      ...
      $data['tab_optinfo']              = $this->language->get('tab_optinfo');
      $data['tab_general']              = $this->language->get('tab_general');
      $data['text_buttonpopup']         = $this->language->get('text_buttonpopup');
      $data['text_namepopup']           = $this->language->get('text_namepopup');
      $data['text_namehover']           = $this->language->get('text_namehover');
      ...
      $data['text_none']                = $this->language->get('text_none');
        ...
        } elseif (!empty($option_info['background_color'])) {
          $data['background_color'] = $option_info['background_color'];
        } else {
        ...
        } elseif (!empty($option_info['text_color'])) {
          $data['text_color'] = $option_info['text_color'];
        } else {
          $data['text_color'] = '';
        }

    if (isset($this->request->post['option_style'])) {
      $data['option_style'] = $this->request->post['option_style'];
    } elseif (!empty($option_info['option_style'])) {
      $data['option_style'] = $option_info['option_style'];
    } else {
      $data['option_style'] = '';
    }
