      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-discount" data-toggle="tab"><?php echo $tab_discount.' (By Quantity)'; ?></a></li>
            <li><a href="#tab-special" data-toggle="tab"><?php echo 'Sale'; ?></a></li>
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" oninput="fillMeta(this)" name="product_description[<?php echo $language['language_id']; ?>][name]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['name'] : ''; ?>" placeholder="<?php echo $entry_name; ?>" id="input-name<?php echo $language['language_id']; ?>" class="form-control p-title" />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea oninput="fillTag(this)" name="product_description[<?php echo $language['language_id']; ?>][meta_keyword]" rows="5" placeholder="<?php echo $entry_meta_keyword; ?>" id="input-meta-keyword<?php echo $language['language_id']; ?>" class="form-control"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['meta_keyword'] : ''; ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-tag<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title="<?php echo $help_tag; ?>"><?php echo $entry_tag; ?></span></label>
                    <div class="col-sm-10">
                      <input type="text" name="product_description[<?php echo $language['language_id']; ?>][tag]" value="<?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['tag'] : ''; ?>" placeholder="<?php echo $entry_tag; ?>" id="input-tag<?php echo $language['language_id']; ?>" class="form-control ptag" />
                    </div>
                  </div>
                </div>
                <?php } ?>
...
<div class="form-group">
  <label class="col-sm-2 control-label" for="input-attribute_group_id"><?php echo 'Attribute Group'; ?></label>
  <div class="col-sm-10">
 ...
 <option value="<?php echo $attribute_group['attribute_group_id']; ?>"><?php echo $attribute_group['name']; ?></option>
	<?php } ?>
          ...
          <td class="text-right"><?php echo $entry_default; ?></td>
          <td class="text-right"><?php echo $entry_extraopt; ?></td>
          ...
          <td class="text-right"><?php echo $entry_image; ?></td>
                          ...
                          <tbody>
                            ...
                            <tr id="option-value-row<?php echo $option_value_row; ?>">
                              <td class="text-left"><select style="padding:0;width:70px" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][option_value_id]" class="form-control">
            ...
            <td class="text-right">
             <label class="radio-inline">
              <?php if ($product_option_value['tmddefault'] == 1) { ?>
              <input type="checkbox" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][tmddefault]" value="1" checked="checked" />
              <?php } else { ?>
              <input type="checkbox" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][tmddefault]" value="1" />
              <?php } ?>
            </label>
          </td>
          <td class="text-right">
            <input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][sku]" value="<?php echo $product_option_value['sku']; ?>" placeholder="<?php echo $entry_sku; ?>" class="form-control" /><br/>
            <input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][upc]" value="<?php echo $product_option_value['upc']; ?>" placeholder="<?php echo $entry_upc; ?>" class="form-control" /><br/>
            <input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][ean]" value="<?php echo $product_option_value['ean']; ?>" placeholder="<?php echo $entry_ean; ?>" class="form-control" /><br/>
            <input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][model]" value="<?php echo $product_option_value['model']; ?>" placeholder="<?php echo $entry_model; ?>" class="form-control" /></td>
          <td class="text-right"><input type="text" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][description]" value="<?php echo $product_option_value['description']; ?>" placeholder="<?php echo $entry_description; ?>" class="form-control" /></td>

           <td class="text-left"><a href="" id="thumb-image<?php echo $option_row; ?><?php echo $option_value_row; ?>" data-toggle="image" class="img-thumbnail"><img src="<?php echo $product_option_value['thumb']; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="product_option[<?php echo $option_row; ?>][product_option_value][<?php echo $option_value_row; ?>][image]" value="<?php echo $product_option_value['image']; ?>" id="input-image<?php echo $option_row; ?><?php echo $option_value_row; ?>" /></td>
...
$.ajax({
url: 'index.php?route=catalog/product/getattributesbygroup&token=<?php echo $token; ?>&attribute_group_id=' +  encodeURIComponent(attribute_group_id),
dataType: 'json',
beforeSend: function(){
...
success: function(json) {
	if(json.length > 0){	
		...
		html  = '<tr id="attribute-row' + attribute_row + '">';
	  	html += '<td class="text-left" style="width: 20%;"><input type="text" name="product_attribute[' + attribute_row + '][name]" value="'+json[i].name+'" placeholder="<?php echo $entry_attribute; ?>" class="form-control" /><input type="hidden" name="product_attribute[' + attribute_row + '][attribute_id]" value="'+json[i].attribute_id+'" /></td>';
...
$('input[name=\'option\']').autocomplete({
	...
	'select': function(item) {
		...
		if (item['type'] == 'select' || item['type'] == 'radio' || item['type'] == 'checkbox' || item['type'] == 'image') {
          ...
          html += '<td class="text-right"><?php echo $entry_default; ?></td>';
          html += '<td class="text-right"><?php echo $entry_extraopt; ?></td>';
          html += '<td class="text-right"><?php echo $entry_description; ?></td>';
...
function addOptionValue(option_row) {
	...
	html += '  <td class="text-left"><select style="padding:0;width:70px" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][option_value_id]" class="form-control">';
  ...
  html += '  <td class="text-right"><label class="radio-inline"><input type="checkbox" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][tmddefault]" value="1" checked="checked" class="form-control" /></label></td>';
  html += '  <td class="text-right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][sku]" value="" placeholder="<?php echo $entry_sku; ?>" class="form-control" /><br/><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][upc]" value="" placeholder="<?php echo $entry_upc; ?>" class="form-control" /><br/><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][ean]" value="" placeholder="<?php echo $entry_ean; ?>" class="form-control" /><br/> <input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][model]" value="" placeholder="<?php echo $entry_model; ?>" class="form-control" /></td>';
  html += '  <td class="text-right"><input type="text" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][description]" value="" placeholder="<?php echo $entry_description; ?>" class="form-control" /></td>';
  html += '  <td class="text-left"><a href="" id="thumb-image' + image_row + '' + option_value_row + '"data-toggle="image" class="img-thumbnail"><img src="<?php echo $placeholder; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][image]" value="" id="input-image' + option_value_row + '' + option_value_row + '" /></td>';

          
	//html += '  <td class="text-right"><a href="" id="thumb-images" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="product_option[' + option_row + '][product_option_value][' + option_value_row + '][option_image]" value="<?php echo $image; ?>" id="input-option_image' + option_value_row + '" /></td>';
...
function fillMeta(id){
    $('.p-meta-title').val($(id).val());
}
...
$('a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
  ...
  if(target=="#tab-data"){
      $('input[name=keyword]').val(toSeoUrl($('.p-title').val()+'-'+Math.round(+new Date()/1000)));
  }
});
//--></script></div>
<?php echo $footer; ?>
