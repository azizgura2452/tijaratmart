      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-option" class="form-horizontal">
          ...
          <ul class="nav nav-tabs">
            ...
            <li><a href="#tab-optinfo" data-toggle="tab"><?php echo $tab_optinfo; ?></a></li>
          </ul>
         ...
         <div class="tab-pane active in" id="tab-general">
          ...
          <div class="tab-pane fade" id="tab-optinfo">
            <div class="form-group">
              <label class="col-sm-2 control-label" for="input-optionstyle"><?php echo $entry_optionstyle; ?></label>
              <div class="col-sm-10">
                <select name="option_style" id="input-optionstyle" class="form-control">
                    <option value="0"><?php echo $text_none; ?></option>
                    <option value="1" <?php if($option_style == 1){ ?> selected="selected" <?php } ?> ><?php echo $text_buttonpopup; ?></option>
                    <option value="2" <?php if($option_style == 2){ ?> selected="selected" <?php } ?> ><?php echo $text_namepopup; ?></option>
                    <option value="3" <?php if($option_style == 3){ ?> selected="selected" <?php } ?> ><?php echo $text_namehover; ?></option>
                </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <?php foreach ($languages as $language) { ?>
              <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                <input type="text" name="option_description[<?php echo $language['language_id']; ?>][option_name]" value="<?php echo isset($option_description[$language['language_id']]['option_name']) ? $option_description[$language['language_id']]['option_name'] : ''; ?>" placeholder="<?php echo $entry_option_name; ?>" class="form-control" />
              </div>
              <?php } ?>
            </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label"><?php echo $entry_option_description; ?></label>
              <div class="col-sm-10">
                <?php foreach ($languages as $language) { ?>
                <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                  <textarea name="option_description[<?php echo $language['language_id']; ?>][option_description]" placeholder="<?php echo $entry_option_description; ?>" class="form-control summernote"><?php echo isset($option_description[$language['language_id']]['option_description']) ? $option_description[$language['language_id']]['option_description'] : ''; ?></textarea>
                </div>
                <?php } ?>
              </div>
            </div>
            <div class="form-group">
              ...
              <?php foreach ($languages as $language) { ?>
              <div class="input-group"><span class="input-group-addon"><img src="language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /></span>
                <input type="text" name="option_description[<?php echo $language['language_id']; ?>][button_text]" value="<?php echo isset($option_description[$language['language_id']]['button_text']) ? $option_description[$language['language_id']]['button_text'] : ''; ?>" placeholder="<?php echo $entry_button_text; ?>" class="form-control" />
              </div>
              <?php } ?>
            </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label"><?php echo $entry_backgroundcolor; ?></label>
              <div class="col-sm-5">
                  <input type="text" class="form-control color" name="background_color" value="<?php echo $background_color; ?>">
              </div>
            </div>
            <div class="form-group">
              <label class="col-sm-2 control-label"><?php echo $entry_textcolor; ?></label>
              <div class="col-sm-5">
                  <input type="text" class="form-control color" name="text_color" value="<?php echo $text_color; ?>">
              </div>
            </div>
