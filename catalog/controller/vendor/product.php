...
class ControllerVendorProduct extends Controller {
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('vendor/product')
		);

		$data['add'] = $this->url->link('vendor/product/add');
		$data['copy'] = $this->url->link('vendor/product/copy');
		$data['delete'] = $this->url->link('vendor/product/delete');
