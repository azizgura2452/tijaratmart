...
class ControllerVendorHeader extends Controller {
	public function index() {
		...
		$data['text_logged'] = sprintf($this->language->get('text_logged'), $this->url->link('vendor/account', '', true), $this->customer->getFirstName(), $this->url->link('vendor/logout', '', true));
		...
		if (!$this->vendor->isLogged()) {
			...
			$data['home'] = $this->url->link('vendor/dashboard', '', true);
		} else {
			$data['logged'] = true;

			$data['home'] = $this->url->link('common/home', '', true);
			$data['logout'] = $this->url->link('vendor/logout', '', true);
