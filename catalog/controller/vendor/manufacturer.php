...
class ControllerVendorManufacturer extends Controller {
	...
	protected function getList() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('vendor/manufacturer')
		);

		$data['add'] = $this->url->link('vendor/manufacturer/add');
		$data['delete'] = $this->url->link('vendor/manufacturer/delete');
		...
		foreach ($results as $result) {
			$data['manufacturers'][] = array(
				...
				'edit'            => $this->url->link('vendor/manufacturer/edit','manufacturer_id=' . $result['manufacturer_id'] . $url, 'SSL')
			);
		}
		...
		$data['sort_name'] = $this->url->link('vendor/manufacturer','sort=name' . $url, 'SSL');
		$data['sort_sort_order'] = $this->url->link('vendor/manufacturer','sort=sort_order' . $url, 'SSL');
		...
		$pagination->url = $this->url->link('vendor/manufacturer',$url . 'page={page}', 'SSL');
	...
	protected function getForm() {
		...
		if (!isset($this->request->get['manufacturer_id'])) {
			$data['action'] = $this->url->link('vendor/manufacturer/add');
		} else {
			$data['action'] = $this->url->link('vendor/manufacturer/edit','manufacturer_id=' . $this->request->get['manufacturer_id'] . $url, 'SSL');
		}

		$data['cancel'] = $this->url->link('vendor/manufacturer');
