...
class ControllervendorFindme extends Controller {
	...
	public function index() {
        ...
        if(isset($vendor_info['company'])){
			$this->document->setTitle($vendor_info['company']);
		} 
		...
		$rating_avg = $this->model_vendor_vendor->getVendorSumValue($this->request->get['vendor_id']);
