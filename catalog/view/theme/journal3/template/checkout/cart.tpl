        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="text-center td-price"><?php echo 'HSN Code'; ?></td>
                    <td class="text-center td-price"><?php echo 'GST'; ?></td>
                ...
                <?php foreach ($products as $product) { ?>
                    ...
                    <button type="button" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-remove" onclick="cart.remove('<?php echo $product['cart_id']; ?>');"><i class="fa fa-times-circle"></i></button>
                        ...
                        <td class="text-center td-price"><?php echo $product['tax_rate_name']; ?></td>
                        <td class="text-center td-price"><?php echo $product['tax']; ?></td>
