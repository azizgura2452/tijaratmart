        ...
        <tr v-for="(product, index) in products">
          ...
          <td class="text-left td-qty">
            <div class="input-group btn-block" style="max-width: 200px;">
              <div class="stepper">
                <input type="text" v-model="product.quantity" v-on:blur="checkSave()" v-on:change="updateCartItemQuantityValue(index, $event.target.value)" class="form-control"/>
                <span>
        ...
        <tr v-for="voucher in vouchers">
          ...
          <td class="text-left">
            <div class="input-group btn-block" style="max-width: 200px;">
              ...
              <span class="input-group-btn">
                    <button type="button" v-on:click="deleteVoucher(voucher)" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger"><i class="fa fa-times-circle"></i></button>
                    </span></div>
          </td>
