...
<ul class="breadcrumb">
  ...
  <?php if ($filedwarning) { ?>
  <div class="alert alert-danger warning"><i class="fa fa-exclamation-circle"></i> <?php echo $filedwarning; ?>  <button type="button" class="close" data-dismiss="alert">&times;</button></div><br/>
  <?php } ?>
  ...
  <?php } ?>
	<div class="row">
		...
		<?php $class = 'col-sm-12'; ?>
		<?php } ?>
		<div id="content" class="<?php echo $class; ?> vendorform"><?php echo $content_top; ?>
			<h1 class="heading-title"><?php echo $heading_title; ?></h1>
			<p class="account-text"><?php echo $text_account_already; ?></p>
				<div class="content">
					...
					<div class="form-group required">
					 <div class="row">
					 <div class="xs-100 sm-50 md-50 lg-50 xl-50">
					...
					<div class="form-group">
					 <div class="row">
					 <div class="xs-100 sm-50 md-50 lg-50 xl-50 required">
					...
					<div class="form-group required">
					 <div class="row">
					 <div class="xs-100 sm-50 md-50 lg-50 xl-50">
					   <label class="label1" for="input-country"><?php echo $entry_country; ?></label>
					...
					<div class="form-group">
						<div class="row">
							 <div class="xs-100 sm-50 md-50 lg-50 xl-50 <?php if ($chkpostcode==1) { ?>required <?php } ?>">
							  <label for="input-postcode" class="control-label" style="width:50%"><?php echo $entry_postcode; ?></label>
					...
					<div class="form-group required">
					 ...
					 <div class="xs-100 sm-50 md-50 lg-50 xl-50">
						<label for="input-confirm" class="control-label label1"><?php echo $entry_confirm; ?></label>
					...
					<?php foreach ($languages as $language) { ?>
					 <li><a href="#tabs<?php echo $language['language_id']; ?>" data-toggle="tab"><img src="catalog/language/<?php echo $language['code']; ?>/<?php echo $language['code']; ?>.png" title="<?php echo $language['name']; ?>" /> <?php echo $language['name']; ?></a></li>
					 <?php } ?>
					</ul> 
					<div class="tabs-content">
				  <?php foreach ($languages as $language) { ?>
					 <div class="tab-pane tab-content" id="tabs<?php echo $language['language_id']; ?>">
					 <div class="form-group required">
					   <label class="col-sm-2 control-label" for="input-name[<?php echo $language['language_id']; ?>]" style="padding-left:15px;"><?php echo $entry_storename; ?></label>
					   <div class="col-sm-10">
					  ...
					  <div class="form-group required">
						...
						<div class="row">
						<div class="xs-100 sm-50 md-50 lg-50 xl-50">
						  <label class="label1" for="input-description[<?php echo $language['language_id']; ?>]"><?php echo $entry_description; ?></label>
						...
						<div class="xs-100 sm-50 md-50 lg-50 xl-50">
						   <label class="label1" for="input-shipping_policy[<?php echo $language['language_id']; ?>]"><?php echo $entry_shippingpolicy; ?></label>
					  ...
					  <div class="form-group required">
						...
						<div class="row">
						<div class="xs-100 sm-50 md-50 lg-50 xl-50">
						<label class="label1" for="input-return_policy[<?php echo $language['language_id']; ?>]"><?php echo $entry_returnpolicy; ?></label>
					  ...
					  <div class="xs-100 sm-50 md-50 lg-50 xl-50">
						<label class="label1" for="input-meta_keyword[<?php echo $language['language_id']; ?>]"><?php echo $entry_metakeyword; ?></label>
					...
					<div class="form-group required">
					   <label style="padding-left: 15px;" class="col-sm-2 control-label" for="input-meta_description[<?php echo $language['language_id']; ?>]"><?php echo $entry_metadescription; ?></label>
					   <div class="col-sm-10">
				 ...
				 <div class="form-group">
				  ...
				  <div class="row">
				   <div class="xs-100 sm-50 md-50 lg-50 xl-50">
					<label class="label1" for="input-detail"><?php echo $entry_detail; ?></label>
				   ...
				   <div class="xs-100 sm-50 md-50 lg-50 xl-50">
					<label class="label1" for="input-store_about"><?php echo $entry_store_about; ?></label>
				 ...
				 <div class="form-group">
				  ...
				  <div class="row">
				   ...
				   <div class="xs-100 sm-50 md-50 lg-50 xl-50">
					  <label for="input-charges" class="label1"><?php echo $entry_charges; ?></label>
				 ...
				 <div class="form-group">
				  ...
				  <div class="row">
				   <div class="xs-100 sm-50 md-50 lg-50 xl-50">
					 <label for="input-keyword"><?php echo $entry_url; ?></label>
					 <input type="text" name="keyword" value="<?php echo $keyword; ?>" placeholder="<?php echo $entry_url; ?>" id="input-keyword" class="form-control" />
				   </div>
				   <div class="xs-100 sm-50 md-50 lg-50 xl-50">
					<label for="input-map_url"><?php echo $entry_mapurl; ?>&nbsp;<a href="https://maps.google.com" target="_blank" data-toggle="tooltip" title="find your map location here"><i class="fa fa-globe" aria-hidden="true"></i></a></label>
					<textarea type="text" name="map_url" placeholder="<?php echo $entry_mapurl; ?>" id="input-mapurl" class="form-control" rows="6"> <?php echo $map_url; ?></textarea>
				   </div>
				  </div>
				  </div>
				 </div>
				  ...
				  <div class="row">
				   <div class="xs-100 sm-50 md-50 lg-50 xl-50">
					 <label for="input-logo"><?php echo $entry_logo;?></label>
					<div class="imagebox">
				   ...
				   <div class="xs-100 sm-50 md-50 lg-50 xl-50">
					 <label for="input-logo"><?php echo $entry_banner;?></label>
					<div class="imagebox">
				 ...
				 <div class="form-group">
				  ...
				  <div class="row">
				   <div class="xs-100 sm-50 md-50 lg-50 xl-50">
					...
					<div class="xs-100 sm-50 md-50 lg-50 xl-50">
					  <div class="col-sm-12">						
							<label for="input-paypal" class="control-label label1"><?php echo $entry_Emailid; ?></label>
				...
				<div class="payment" id="payment-banktransfer">
				  <div class="form-group required">
				   ...
				   <div class="row">
					<div class="xs-100 sm-50 md-50 lg-50 xl-50">
					   <label for="input-bankname"><?php echo $entry_bankname;?></label>
					...
					<div class="xs-100 sm-50 md-50 lg-50 xl-50">
					 <label for="input-branch_number"><?php echo $entry_bnumber;?></label>
				  ...
				  <div class="form-group required">
				   <div class="col-sm-12">
					  <div class="row">
					 <div class="xs-100 sm-50 md-50 lg-50 xl-50">				   
					 <label for="input-swift_code"><?php echo $entry_swiftcode; ?></label>
					...
					<div class="xs-100 sm-50 md-50 lg-50 xl-50">	
					  <label for="input-package-title"><?php echo $entry_aname;?></label>
				...
				<div class="col-sm-12">
				   <div class="row">
					<div class="xs-100 sm-50 md-50 lg-50 xl-50">	
					  <label for="input-account_number"><?php echo $entry_anumber;?></label>
...
.note-popover.popover{display: none !important;}
.panel-default .btn-default i.fa{color: #777 !important;}
.panel-default .btn-default{
    background-color: #e7e7e7;
    color: #777 !important;
}
.note-btn-group{display: inline-block;}
#input-description1{height: 0px;min-height: 0px;}
.oc2 .form-horizontal .form-group .radio-inline{width:40%;padding-top: 0;padding-right: 10px;}
.label1{width:100% !important;}
select{width: 100%;}
.xl-50{padding: 0 5px;}
.thumb{border:solid 1px #ddd;padding:5px;vertical-align: middle;}
</style>
<script type="text/javascript"><!--
