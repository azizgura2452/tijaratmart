<div class="row main-products product-grid" data-grid-classes="<?php echo $this->journal2->settings->get('product_grid_classes'); ?> xs-100 sm-50 md-33 lg-33 xl-33 ">
	...
	<div class="product-grid-item xs-100 sm-50 md-33 lg-33 xl-33">
            ...
            <div class="product-details">
				<div class="caption">
				 ...
				 <div class="button-group">
                   <div class="cart">
                     <a onclick="addToCart('cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');');" class="button hint--top" data-hint="<?php echo $button_cart; ?>"><i class="button-left-icon"></i><span class="button-cart-text"><?php echo $button_cart; ?></span><i class="button-right-icon"></i></a>
                   </div>
