<div class="modal-dialog modal-lg">
  <div class="modal-content">
    <div class="modal-header">
	  ...
	  <div class="alert alert-warning">Create New Folder Before Upload Image</div>
    </div>
...
$('#button-search').on('click', function(e) {
	var url = 'index.php?route=vendor/filemanager';
...
$('#button-upload').on('click', function() {
	...
	timer = setInterval(function() {
		if ($('#form-upload input[name=\'file\']').val() != '') {
			...
			$.ajax({
				url: 'index.php?route=vendor/filemanager/upload&directory=<?php echo $directory; ?>',
				type: 'post',
				dataType: 'json',
...
$('#button-folder').on('shown.bs.popover', function() {
	$('#button-create').on('click', function() {
		$.ajax({
			url: 'index.php?route=vendor/filemanager/folder&directory=<?php echo $directory; ?>',
			type: 'post',
			dataType: 'json',
...
$('#modal-image #button-delete').on('click', function(e) {
	if (confirm('<?php echo $text_confirm; ?>')) {
		$.ajax({
			url: 'index.php?route=vendor/filemanager/delete',
			type: 'post',
			dataType: 'json',
