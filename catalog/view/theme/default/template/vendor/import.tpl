...
<div id="content">
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
		<a class="btn btn-primary" onclick="$('#tmd-import').submit();" class="button"><?php echo $button_import; ?></a>
      </div>
  ...
  <div class="container-fluid">
    ...
    <div class="panel-body">
      <form action="<?php echo $import; ?>" method="post" enctype="multipart/form-data" id="tmd-import">
