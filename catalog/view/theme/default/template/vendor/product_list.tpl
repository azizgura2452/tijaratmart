        ...
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              ...
              <button style="margin-top:12%;" type="button" id="button-filter" class="btn btn-primary pull-right col-sm-12"><i class="fa fa-search"></i> <?php echo $button_filter; ?></button>
			   </div>
            </div>
          </div>
        </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover">
              ...
              <tbody>
				...
				<?php if ($chkautoapprovedproduct==1) { ?>				  
                  <td class="text-center" width="170px">
                    <div class="form-group">
                      <label class="col-sm-2 control-label"></label>
                      <div class="col-sm-10">
                        <label class="switch inputbundle<?php echo $product['product_id']; ?>" >
                          <input type="checkbox" value="1" name="status" class="quick-status" rel="<?php echo $product['product_id']; ?>" <?php if ($product['chkstatus']) { ?> checked="checked" <?php } ?> >
                          <span class="slider round <?php if ($product['statusvalue']==2) { ?> chkaproval	<?php } ?>"></span>
                          <span class="absolute-no <?php if ($product['statusvalue']==2) { ?> chkaproval	<?php } ?>"><?php echo $text_disabled; ?></span>
                        </label>
                      </div>
						<?php if ($product['statusvalue']==2) { ?>						
						<span class="approval"><?php echo $text_approvepending; ?></span>
						<?php } ?>	
					</div>
                  </td>
				<?php } else { ?>
				
				<td class="text-left"><span class="label<?php if ($product['status']=='Disabled') { ?> label-danger <?php } elseif($product['status']=='Approval Pending') { ?> label-warning <?php }else { ?> label-success <?php } ?>"><?php echo $product['status']; ?></span></td>			
				
				<?php } ?>	
                <!-- new code 5 march 2020 -->
				
                  <td class="text-center"><a href="<?php echo $product['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn"> <i class="fa fa-pencil-square-o eyeicon" aria-hidden="true"></i> </a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
<!--2020-->
<style>
.slider:after {content: "<?php echo $text_enable; ?>";}
</style>
<?php echo $footer; ?>