            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-center"><a href="<?php echo $option['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn">  <i class="fa fa-pencil-square-o eyeicon" aria-hidden="true"></i></a></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
