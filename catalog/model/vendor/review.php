...
class ModelVendorReview extends Model {
	...
	public function deleteReview($review_id) {
		$sql="delete  from " . DB_PREFIX . "vendor_review where review_id='".$review_id."'";
		$query=$this->db->query($sql);
		$sql="delete  from " . DB_PREFIX . "vendor_review_field_submit where review_id='".$review_id."'";
		$query=$this->db->query($sql);
	}
	
	public function getReview($review_id) {
		$sql = "SELECT * FROM " . DB_PREFIX . "vendor_review where review_id='".$review_id."'";
		$query = $this->db->query($sql);
		return $query->row;
	}
