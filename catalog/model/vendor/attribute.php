<?php
class ModelVendorAttribute extends Model {
	public function addAttribute($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "vendor_to_attribute SET attribute_id = '" . (int)$attribute_id . "', vendor_id = '" . $this->vendor->getId() . "'");
	...
	public function getTotalAttributes($data) {
		$sql = "SELECT COUNT(*) AS total FROM " . DB_PREFIX . "attribute a LEFT JOIN " . DB_PREFIX . "attribute_description ad ON (a.attribute_id = ad.attribute_id) LEFT JOIN " . DB_PREFIX . "vendor_to_attribute v2a ON (a.attribute_id = v2a.attribute_id) WHERE ad.language_id = '" . (int)$this->config->get('config_language_id') . "' and v2a.vendor_id<>0";	
