...
class ModelVendorDownload extends Model {
	public function addDownload($data) {
		...
		$this->db->query("INSERT INTO " . DB_PREFIX . "vendor_to_download SET download_id = '" . (int)$download_id . "', vendor_id = '" . $this->vendor->getId() . "'");
	...
	public function getDownloads($data = array()) {
		...
		if(isset($data['vendor_id'])){
			$sql .= " and v2d.vendor_id='".$data['vendor_id']."'";
		}
